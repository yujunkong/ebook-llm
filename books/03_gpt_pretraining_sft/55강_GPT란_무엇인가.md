...
- GPT가 제품 이름이 아니라 아키텍처·학습 패러다임의 계열명으로 쓰이는 이유
...
![그림 55-1](images/fig55-01.png)

짧은 문장 토큰 `나 / 는 / 학 / 생`을 모델이 차례로 예측한다고 합시다.

$$
P(x)=\prod_t p_\theta(x_t\mid x_{<t})
$$

| $t$ | 토큰 | $p_\theta(x_t\mid x_{<t})$ |
|---|---|---|
| 1 | 나 | 0.40 |
| 2 | 는 | 0.55 |
| 3 | 학 | 0.30 |
...
$$
P = 0.40\times 0.55\times 0.30\times 0.70 = 0.0462
$$

GPT는 “문장 전체 점수”를 **다음 토큰 확률의 곱**으로 만드는 모델입니다.
...
- **이전 강:** [54강. 2권 총정리 — GPT로 가는 길](../02_tokenizer_transformer/54강_2권_총정리_GPT로_가는_길.md)
- **다음 강:** [56강. GPT 아키텍처 구현](56강_GPT_아키텍처_구현.md)
