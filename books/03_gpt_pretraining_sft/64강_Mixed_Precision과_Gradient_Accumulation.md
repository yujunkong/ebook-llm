...
제62~63강에서 학습 루프와 AdamW·스케줄을 조립했다. 이번 강의는 GPU 메모리를 넘지 않으면서도 **실효 배치**와 **처리량**을 확보하기 위한 두 축, **Mixed Precision(혼합 정밀도)** 과 **Gradient Accumulation(기울기 누적)** 을 다룬다.
