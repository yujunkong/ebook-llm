...
제69강에서 Instruction Tuning과 SFT의 자리를 잡았다. 이번 강의는 **데이터가 파일에 어떤 모양으로 앉는지**를 고정한다. 형식이 흔들리면 제71강 마스크 손실과 제72강 Chat Template이 전부 흔들린다.
...
- **Prompt masking**이 왜 필요한지 미리보기 (구현은 제71강)
