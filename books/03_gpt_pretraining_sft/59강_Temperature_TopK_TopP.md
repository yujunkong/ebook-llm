...
## 수식 보강 — Temperature와 엔트로피

$p=\mathrm{softmax}(z/\tau)$일 때 $\tau$가 커지면 엔트로피

$$
H(p)=-\sum_k p_k\log p_k
$$

가 커지는 경향이 있습니다(분포가 평평). 샘플링 다양성 vs 정확도의 트레이드오프를 $\tau$로 조절합니다.
