...
제58강에서 Greedy와 원분포 Sampling 루프를 만들었다. 이번 강의는 Softmax에 들어가기 **직전·직후**의 분포를 변형하는 세 가지 손잡이를 다룬다.
...
이번 강의는 3권 생성편의 **핵심 장**이다. 수식·숫자·코드를 모두 남긴다.
