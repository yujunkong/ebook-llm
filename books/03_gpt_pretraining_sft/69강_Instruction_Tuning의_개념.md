...
제68강까지는 **Pretraining**으로 “다음 토큰을 예측하는 언어 모델(base LM)”을 만들었다. 이번 강의부터는 그 모델을 **지시를 따르는 모델**로 바꾸는 첫 개념인 **Instruction Tuning(인스트럭션 튜닝)**을 다룬다.
...
### 8. Instruction Tuning이 잘하는 것 / 못하는 것
