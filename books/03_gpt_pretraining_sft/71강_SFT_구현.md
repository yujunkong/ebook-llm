...
프롬프트 구간 $\mathcal{P}$, 응답 구간 $\mathcal{R}$에 대해

$$
L=-\sum_{t\in\mathcal{R}}\log p_\theta(y_t\mid \mathrm{context}_{<t})
$$
