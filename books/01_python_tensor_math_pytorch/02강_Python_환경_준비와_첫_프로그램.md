...
1강에서 학습 지도를 그렸다. 이번 강의부터는 실제로 코드를 실행한다.
...
- 이후 NumPy·PyTorch 설치가 가능한지 점검하는 방법을 안다
...
#### 4.1 Python 버전: 3.11 이상을 권장하는 이유
...
#### 7.3 (나중을 위한) NumPy / PyTorch 설치 점검
...
- **이전 강:** [제1강. LLM을 밑바닥부터 배운다는 것](01강_LLM을_밑바닥부터_배운다는_것.md)
- **다음 강:** [제3강. 변수, 자료형, 연산](03강_변수_자료형_연산.md)
