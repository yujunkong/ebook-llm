...
11강에서 미분과 편미분을 배웠다. 이번 강의는 그 편미분을 **모아서 방향**으로 만들고, 그 방향으로 **Loss를 줄이며 파라미터를 갱신**한다.
...
15강 이후 Neural Network, 그리고 실제 GPT 학습도 뼈대는 이 강의와 같다.
...
### 8. Vector / Matrix Parameter로 일반화
