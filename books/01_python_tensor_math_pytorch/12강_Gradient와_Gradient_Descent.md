...
<!-- visual-example-12 -->
## 숫자로 따라가기 — Gradient Descent

![그림 12-1](images/fig12-01.png)

손실 곡선 위에서 파라미터를 **기울기 반대 방향**으로 조금 옮깁니다.
...
|---|---|---|
| $\theta$ | $2.0$ | 지금 파라미터 |
| $\nabla L$ | $4.0$ | “이 방향으로 L이 커짐” |
| $\eta$ | $0.1$ | 한 걸음 크기 |

계산:

$$
\theta_{\mathrm{new}} = 2.0 - 0.1 \times 4.0 = 1.6
$$

직관: 기울기가 양수(+4)면 $\theta$를 **줄여** 언덕을 내려갑니다. $\eta=1.0$이면 $2-4=-2$로 멀리 뛰어 진동할 수 있습니다.
