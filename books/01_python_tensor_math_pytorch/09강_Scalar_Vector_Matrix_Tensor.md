...
8강까지 NumPy로 배열을 다루었다. 이번 강의부터는 그 배열을 **수학의 언어**로 다시 본다.

이 강의를 마치면 다음을 말할 수 있어야 한다.

- **Scalar**, **Vector**, **Matrix**, **Tensor**가 각각 무엇인지
...
이번 강의는 “이름만 외우기”가 아니다. 이후 내적, 행렬곱, Gradient, Loss, Backpropagation이 모두 이 위에서 동작한다.
