...
<!-- visual-example-13 -->
## 숫자로 따라가기 — Loss가 “틀린 정도”

![그림 13-1](images/fig13-01.png)
...
**Cross-Entropy (분류·LLM)** — 정답 클래스 확률만 봅니다.

$$
L = -\log p_{y} 
$$

| $p_{\mathrm{정답}}$ | $-\log p$ (대략) | 느낌 |
|---|---|---|
| 0.8 | 0.22 | 거의 맞음 |
| 0.5 | 0.69 | 애매 |
| 0.1 | 2.30 | 크게 틀림 |

LLM 학습은 다음 토큰의 $p_{\mathrm{정답}}$을 올려 $-\log p$를 줄이는 과정입니다.
