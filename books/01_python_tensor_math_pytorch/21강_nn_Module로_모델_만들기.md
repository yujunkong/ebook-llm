...
제20강까지 Autograd로 기울기를 자동 계산하는 방법을 익혔다. 이번 강의부터는 그 기울기가 **모델 안의 파라미터**에 붙도록, PyTorch가 제공하는 모델 작성 단위를 배운다.
...
#### 4.4 parameters()와 named_parameters()
...
### 9. PyTorch로 구현하기 — Sequential과 수동 forward
