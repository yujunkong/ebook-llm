...
제11~14강에서 미분, Gradient, Loss, Chain Rule을 다뤘다. 이제 그 도구가 붙을 **본체인 Neural Network**를 조립한다.
...
이번 강의는 “학습 알고리즘”보다 **구조의 이름표**를 붙이는 장이다. Forward와 Backpropagation은 16~18강에서 이어진다.
...
#### 4.6 Activation Function (활성화 함수)
