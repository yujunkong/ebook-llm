...
![그림 81-1](images/fig81-01.png)

상태 $s$에서 행동 분포 $\pi=[0.6,\,0.3,\,0.1]$, 가치 $V(s)=3.2$.

| 기호 | 값 | 의미 |
|---|---|---|
| $\pi(a\mid s)$ | $[0.6,0.3,0.1]$ | 다음 토큰 확률 |
| $V^\pi(s)$ | $3.2$ | 이 문맥에서 기대 리턴 |
| $Q(s,a_1)$ (가정) | $4.0$ | 첫 행동의 행동가치 |

$$
A(s,a_1)=Q-V=4.0-3.2=+0.8
$$

Policy는 **무엇을 고를지**, Value는 **지금 문맥이 얼마나 좋은지**입니다.
...
- **이전 강:** [80강. 강화학습 기초 — State, Action, Reward](80강_강화학습_기초_State_Action_Reward.md)
- **다음 강:** [82강. Policy Gradient](82강_Policy_Gradient.md)
