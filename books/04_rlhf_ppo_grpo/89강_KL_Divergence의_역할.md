...
![그림 89-1](images/fig89-01.png)

두 분포 $p=[0.7,0.3]$, $q=[0.5,0.5]$:

$$
\mathrm{KL}(p\|q)\approx 0.7\log\frac{0.7}{0.5}+0.3\log\frac{0.3}{0.5}\approx 0.082
$$

$p=q$면 0. RLHF에서 $\beta\,\mathrm{KL}(\pi\|\pi_{\mathrm{ref}})$는 **참조에서 너무 멀어지지 말 것** 브레이크입니다.
