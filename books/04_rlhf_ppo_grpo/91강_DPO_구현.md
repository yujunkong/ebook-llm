...
제90강에서 DPO 손실을 유도했다. 이번 강의는 **같은 식을 PyTorch로 옮기는 실습 강의**다. 대형 모델·분산 학습은 목표로 하지 않는다. 장난감 배치 하나로 “숫자가 식을 따르는지”를 확인한 뒤, 학습 루프의 골격만 잡는다.
