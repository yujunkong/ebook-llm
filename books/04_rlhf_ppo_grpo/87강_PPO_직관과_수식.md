...
제86강에서 RLHF 파이프라인을 조립했다. 이번 강의는 그 파이프라인의 업데이트 규칙인 **PPO(Proximal Policy Optimization)** 를 직관과 수식으로 이해한다.
...
제88강에서 토이 루프로 구현한다. 여기서는 **왜 이 식인가**에 집중한다.
