...
<!-- visual-example-80 -->
## 숫자로 따라가기 — 토큰 MDP와 Return

![그림 80-1](images/fig80-01.png)

프롬프트 뒤 토큰 3개를 생성하고, 마지막에만 보상 $r=5$, 할인 $\gamma=0.9$.
...
| $t$ | $r_t$ | $G_t$ |
|---|---|---|
| 0 | 0 | $0+0.9\cdot0+0.81\cdot5=4.05$ |
| 1 | 0 | $0+0.9\cdot5=4.5$ |
| 2 | 5 | $5$ |

LLM RL에서 **행동=토큰**, **상태=문맥**, **보상은 종종 시퀀스 끝**에 옵니다.
