...
36~38강에서 Q/K/V · 점수 · Softmax · Value 가중합을 조각으로 익혔다.  
이번 강의는 이를 **하나의 Self-Attention 모듈**로 조립한다.
...
- Causal Mask를 넣을 **위치**만 표시해 40강으로 연결하기

“식을 안다”에서 “코드로 돌린다”로 넘어가는 강의다.
