...
이 폴더는 《밑바닥부터 LLM》 2권(27~54강) 원고를 둔다.

| 강 | 파일 | 상태 |
|---:|---|---|
| 27 | [27강_텍스트가_숫자가_되는_과정.md](27강_텍스트가_숫자가_되는_과정.md) | 작성 완료 |
...
| 50 | [50강_프로젝트_Mini_Transformer_구현_2.md](50강_프로젝트_Mini_Transformer_구현_2.md) | 작성 완료 |
| 51 | [51강_Attention_시각화.md](51강_Attention_시각화.md) | 작성 완료 |
| 52 | [52강_계산_복잡도와_메모리.md](52강_계산_복잡도와_메모리.md) | 작성 완료 |
| 53 | [53강_최신_Transformer_변형_개요.md](53강_최신_Transformer_변형_개요.md) | 작성 완료 |
| 54 | [54강_2권_총정리_GPT로_가는_길.md](54강_2권_총정리_GPT로_가는_길.md) | 작성 완료 |
