...
2권의 부품(Tokenizer 개념, Embedding, Attention, Block, Causal LM 골격)을 **하나의 실행 가능한 Mini Transformer**로 조립하기 시작한다. 이번 강의(1부)는 **뼈대**다.
...
이번 강의와 제50강은 2권에서 **가장 긴 실전 강의**다. 코드를 복사만 하지 말고, 디렉터리를 만들어 실행한다.
...
### 6. `tokenizer.py` — 문자 단위 toy tokenizer
