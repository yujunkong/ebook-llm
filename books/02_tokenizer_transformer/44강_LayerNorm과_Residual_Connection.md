...
제41강까지 Attention의 “내용”을 만들었고, 제42~43강에서 위치까지 심었다.  
이제는 층을 **깊게 쌓아도 학습이 붕괴하지 않게** 만드는 두 장치를 본다.
...
- **RMSNorm**이 무엇인지, 현대 LLM에서 자주 보이는 이유(사실/설명 구분)
- Pre-LN과 Post-LN의 배치 차이(제46강 예고)
