...
표준 Causal Transformer(제48~50강)의 **변형이 왜 등장하는지**를 지도로만 훑는다. 구현·벤치마크·수치는 단정하지 않는다.
...
- **사실(구조/동기)**과 **설명(대략적 이득)**과 **시시각각 변하는 세부**를 구분한다.
...
- **이전 강:** [제52강. 계산 복잡도와 메모리](52강_계산_복잡도와_메모리.md)
- **다음 강:** [제54강. 2권 총정리 — GPT로 가는 길](54강_2권_총정리_GPT로_가는_길.md)
