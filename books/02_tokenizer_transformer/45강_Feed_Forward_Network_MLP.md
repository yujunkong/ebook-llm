...
![그림 45-1](images/fig45-01.png)

$d=2$, $d_{\mathrm{ff}}=4$, $\mathbf{x}=[1,\ 2]$, bias $0$:

$$
\mathbf{x}W_1=[1,\ 2,\ 1,\ 0]
\xrightarrow{\mathrm{ReLU}}[1,\ 2,\ 1,\ 0]
$$
...
Attention이 위치를 섞은 뒤, FFN은 **토큰마다 같은 MLP**로 내용을 비선형 변환합니다 (위치 간 섞지 않음).
