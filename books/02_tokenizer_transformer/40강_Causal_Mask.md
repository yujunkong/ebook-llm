...
<!-- visual-example-40 -->
## 숫자로 따라가기 — Causal Mask

![그림 40-1](images/fig40-01.png)

3×3 점수에서 **위삼각형(미래)** 을 $-\infty$로 바꿉니다.

$$
\mathrm{softmax}(-\infty)=0
$$

그래서 위치 0은 자기만, 위치 1은 0·1만, 위치 2는 0·1·2만 봅니다.  
GPT가 “아직 안 나온 다음 글자”를 훔쳐보지 못하게 하는 장치입니다.
