...
39강에서 Self-Attention 모듈을 조립했다.  
이번 강의는 언어모델(GPT류)에 필수인 **Causal Mask(인과 마스크)**를 넣는다.
...
33강 Softmax → 34강 CE로 “출력단”을 만들었듯,  
36~39강 Attention → 40강 Causal Mask로 “문맥단의 LM 규칙”을 완성한다.
