...
<!-- visual-example-33 -->
## 숫자로 따라가기 — Softmax 손계산

![그림 33-1](images/fig33-01.png)
...
$$
Z = 7.39+2.72+1.11 \approx 11.22
$$

$$
p = \left[\frac{7.39}{11.22},\,\frac{2.72}{11.22},\,\frac{1.11}{11.22}\right]
\approx [0.66,\,0.24,\,0.10]
$$

합이 1인지 확인: $0.66+0.24+0.10=1.00$.  
LLM에서는 $z$ 길이가 vocab 크기 $V$(수만~십만)인 것만 다르고, **같은 정규화**입니다.
