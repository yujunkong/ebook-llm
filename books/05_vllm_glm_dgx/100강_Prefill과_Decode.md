...
## 제100강. Prefill과 Decode

### 1. 이번 강의에서 배울 것

제99강에서 Training과 Inference의 경계를 고정했다. 이번 강의는 **한 요청**이 GPU 위에서 겪는 두 국면 — **Prefill(프리필)** 과 **Decode(디코드)** — 를 분해한다.
...
벤치마크 “몇 ms”를 외우는 강의가 아니다. **국면 분리**가 목표다.
...
#### 8.2 PyTorch — 캐시 없이 Prefill/Decode를 “시간으로만” 구분
